    ...
    async function toggleWishlist(id) {
        ...
        if (localWishlistItems.includes(id)) {
            ...
            if (res.data.status === "success") {
                ...
                updatedWishlist = localWishlistItems.filter(
                    (item) => item !== id
                );
                    ...
                    <div className="row pt-5 align-items-center">
                        <div className="col-md-4 products">
                            ...
                            <Slider className="mb-5" {...settings}>
                                {productDetails.images.map((ele, index) => (
                        ...
                        <div className="col-md-8">
                            ...
                            <button
                                onClick={() => addCart(productDetails.id)}
                                className="mt-3 btn bg-main text-white w-100"
                            >
                                Add To Cart
                            </button>
                        </div>
